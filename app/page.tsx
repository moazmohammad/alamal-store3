...
import { ShoppingCart, Star, Search, BookOpen, Gamepad2, PenTool, Heart, User, MessageSquare } from "lucide-react"
              ...
              <Card key={product.id} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent className="p-3 md:p-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      <Heart
                        className={`h-3 w-3 md:h-4 md:w-4 ${favorites.includes(product.id) ? "fill-current" : ""}`}
                      />
                    </Button>
                  </div>
                </CardContent>
